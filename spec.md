...
- **§4c. Trí nhớ của học trò — bản đồ hiểu biết** *(đỉnh và cạnh **đã có trong bản build**, 18/9)*
  ...
  **Phiên nối hai trang (đã build).** Trên bản đồ: chọn một trang sáng → "Nối với trang khác" → chọn trang đích (đường nét đứt đi theo con trỏ, trang không nối được mờ đi, Esc để huỷ) → phiên nối mở ngay trong khung bên phải. Câu mở bài dựng từ **chính lời học viên đã giảng ở hai trang** (`link_opener/v2`, `open_link_session`): model chỉ được thấy những câu đó chứ không thấy nguồn, nhắc lại mỗi trang một ý bằng lời của họ, rồi hỏi theo đúng MỘT hướng — hai thứ đó giống nhau ở đâu, khác nhau ở đâu, hay cái này làm cái kia thay đổi. Cùng một chữ mang hai nghĩa ở hai trang thì luôn hỏi hướng phân biệt: "Bạn nói Context là lượng chữ model thấy trong một lần, còn trang Hệ thống AI gọi Context là tri thức riêng của doanh nghiệp — hai Context đó khác nhau ở chỗ nào?" Bản trước hỏi cố định "hai trang đó liên quan gì với nhau" và mời đúng câu trả lời rỗng "đều nói về AI". Câu mở đi qua các guard của một câu agent nói ra (lộ đáp án, "có phải… không", nhận vai người giảng, phải chạm cả hai trang); trượt hai lần thì về câu viết sẵn. Chấm bằng prompt riêng `grader_link`: chỉ đòi MỘT mối nối có căn cứ, theo bất kỳ kiểu nào trong ba kiểu — tác động, điểm chung, phân biệt — miễn là nói được cụ thể (`grader_link/v4`), không đòi giảng lại từng trang; dùng lại nguyên `decide()`, câu hỏi ngược và mọi guard. Nối được thì cạnh được vẽ dần ra trên bản đồ, kèm đúng câu nối của học viên; nối sai hay chưa tới thì không có cạnh, và **hai trang vẫn sáng** — hiểu sai cách hai trang liên quan không có nghĩa là hiểu sai từng trang.
...
| 18/9 17:00 | Câu mở phiên nối dựng từ **chính lời học viên đã giảng ở hai trang**, hỏi theo một trong ba hướng: giống nhau ở đâu, khác nhau ở đâu, hay cái này làm cái kia thay đổi (`link_opener/v2`); `grader_link` v4 chấm đủ ba kiểu nối | Câu cố định "hai trang đó liên quan gì với nhau" mời đúng câu trả lời rỗng "đều nói về AI", và nhiều cặp trang đáng PHÂN BIỆT hơn là đáng nối — người thử đã dùng chữ "context" theo hai nghĩa ở hai trang mà không nhận ra. Đo 6 cặp × 2 lượt trên model thật: 12/12 qua chốt ngay lần đầu, 8 câu chọn hướng phân biệt |
| 18/9 17:40 | Học trò được viết **một hoặc hai câu** thay vì ép một câu (`opener/v3`, `student_persona/v3`, `link_opener/v2`, `persona_v3`); thêm sàn tất định `speakable()` đổi gạch dài, chấm phẩy, mũi tên thành dấu phẩy | Người thử chê câu chữ như ghi chú: "Mình chưa rõ: nguồn tách Generative AI và LLM — bạn giải giúp chỗ khác biệt chức năng giữa chúng được không?" Ép một câu thì model buộc phải nén hai ý lại bằng dấu. Đo cùng một trang, mỗi bản 2 lượt: bản cũ vẫn nén bằng ";" và "—", bản mới ra hai câu trọn vẹn. Golden set giữ nguyên 23/26, điều kiện cứng ĐẠT |
| 18/9 18:00 | Mô tả hình cho **cả thư viện** (28 bộ, 1.645 ô hình) bằng model có thị giác; chọn đúng một cái hình thì vẫn lấy chữ của cả trang; bộ slide đọc lại khi có mô tả mới, không đợi khởi động lại | Chọn sơ đồ ở trang "Sự ra đời của Deep Learning" thì học trò hỏi "trong hình minh hoạ đó, chỗ nào đang diễn tả ý chính của slide?" — hai nguyên nhân: bộ slide đó chưa chạy `describe_figures`, và `lesson_from_selection` coi "có hình" là đã đủ dày nên bỏ luôn bước nới ra cả trang. Sau khi sửa, đúng trang đó hỏi "vì sao Perceptrons 1969 dẫn tới mùa đông tiếp theo?" |
